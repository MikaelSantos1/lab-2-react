                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6 ">
                            <img
                             src="https://www.github.com/MikaelSantos1.png" 
                             alt="Avatar"
                             className="h-16 w-16 rounded-full border-2 border-blue-500"
                             />
                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Professor taltaltaltal</strong>
                                <span className="text-gray-200 text-sm block">CTO at</span>
                            </div>
                        </div>
                    </div>
